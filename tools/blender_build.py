...
def b_tv_cabinet():
    ...
    # v2 全覆盖门板（参照 wardrobe v2 先例）：门板铺满前脸只留真实级细缝——
    # 中缝 4mm、两侧/上下缝 2mm；旧 0.72×0.36 门板中缝 8cm、四周 2cm，能看穿柜体。
    # 门背贴柜体前口(z 0.21)、外凸 3cm；铰链=门缘 ±0.798 → interact.js hinge 同步 [-0.798,0.28,0.225]
    reg(join([B(0.796, 0.436, 0.03, -0.4, 0.28, 0.225, M('wood_light'), 'd', 0.006),
              B(0.1, 0.025, 0.025, -0.08, 0.28, 0.2525, M('dark'), 'h')], 'part_doorL'))
    reg(join([B(0.796, 0.436, 0.03, 0.4, 0.28, 0.225, M('wood_light'), 'd', 0.006),
              B(0.1, 0.025, 0.025, 0.08, 0.28, 0.2525, M('dark'), 'h')], 'part_doorR'))
